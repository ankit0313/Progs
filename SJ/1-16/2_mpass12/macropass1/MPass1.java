...
public class MPass1 {
	public static void main(String[] args) throws IOException {
		...
		BufferedReader br1=new BufferedReader(new FileReader("D:/LP//input3.txt"));
	 	String line;
	 	mdt[] MDT=new mdt[20];
	 	mnt[] MNT=new mnt[4];
	 	...
	 	br1.close();
	 		// We have to change this path
	 	BufferedWriter bw1=new BufferedWriter(new FileWriter("D:/LP//MNT.txt"));
	 	System.out.println("\n\t********MACRO NAME TABLE**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		bw1.close();
			// We have to change this path
		bw1=new BufferedWriter(new FileWriter("D:/LP//ARGLIST.txt"));
		System.out.println("\n\n\t********ARGUMENT LIST**********");
		System.out.println("\n\tINDEX\tNAME\tADDRESS");
		...
		System.out.println("\n\tINDEX\t\tSTATEMENT");
			// We have to change this path
		bw1=new BufferedWriter(new FileWriter("D:/LP//MDT.txt"));
